...
In case the `check_recommended` attribute for this class is `True` (default), this will show the student warnings about missing recommended attributes (see [here](#test)).