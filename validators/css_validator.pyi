...
class Rule:
    ...
    def compare_to(
        self, value: Optional[str] = None, important: Optional[bool] = None, any_order: bool = False
    ) -> bool: ...
...
class Rules:
    ...
    def find(
        self, root: ElementBase, solution_element: ElementBase, key: str, pseudo: Optional[str]
    ) -> Optional[Rule]: ...
